...
const BannerAdRight: React.FC<{ visible?: boolean }> = ({ visible = true }) => (
  <div className={`banner-ad banner-ad-right hidden xl:block ${visible ? "banner-ad-visible" : "banner-ad-hidden"}`}>
