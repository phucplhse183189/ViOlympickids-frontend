          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50/50">
                ...
                <th className="text-left text-slate-500 text-xs font-semibold uppercase tracking-wide px-5 py-3.5 hidden md:table-cell">
                  Chủ đề
                </th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-center">
                      <span
                        className={`text-xs font-bold px-2.5 py-1 rounded-md ${plan.bg} ${plan.color}`}
                      >
                        {lesson.requiredPlan}
                      </span>
                    </td>
                    <td className="px-5 py-3.5 text-right">
                      <button
                        ...
                        className="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors font-medium text-sm inline-flex items-center gap-1"
                      >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:border-indigo-500"
                  placeholder="VD: theory, quiz, matching..."
                />
              </div>
            </div>
