...
export const translations = {
  vi: {
    ...
    feedback: {
      ...
      eyebrow: "Phụ huynh nói gì về chúng tôi",
      headline: "Hàng ngàn gia đình đã tin tưởng",
      viewAll: "Xem tất cả đánh giá",
      replies: "trả lời",
      categories: { interface: "Giao diện", feature: "Tính năng", content: "Nội dung", performance: "Hiệu năng", support: "Hỗ trợ", general: "Khác" },
  ...
  en: {
      ...
      plans: [
        {
          ...
          badge: "",
          features: [
            { text: "Limited 3D lessons", included: true },
            { text: "Basic practice", included: true },
            { text: "Includes advertising", included: false },
            { text: "No progress reports", included: false },
            { text: "No personalization", included: false },
          ],
        ...
        },
        {
          ...
          price: "$2.50",
          period: "/month",
          pricing: ["$7 / 3 months", "$18 / year"],
          badge: "Parents' favourite",
          features: [
            { text: "Full access to 3D lessons", included: true },
            { text: "Standard practice", included: true },
        ...
        },
        {
          ...
          price: "$4",
          period: "/month",
          pricing: ["$11 / 3 months", "$32 / year"],
          badge: "",
          features: [
            { text: "Advanced 3D lessons", included: true },
            { text: "Competition practice", included: true },
    ...
    feedback: {
      ...
      eyebrow: "What parents say about us",
      headline: "Thousands of families trust",
      viewAll: "View all reviews",
      replies: "replies",
      categories: { interface: "Interface", feature: "Features", content: "Content", performance: "Performance", support: "Support", general: "Other" },
