...
export const translations = {
  vi: {
    ...
    courses: {
      ...
      titleAccent: "cho tương lai của con",
      traditional: {
        title: "Gia sư / Học thêm offline",
        price: "1.000.000đ – 2.000.000đ/tháng",
        cons: [
          "Tốn thời gian đưa đón",
          "Khó kiểm soát chất lượng từng buổi",
          "Bé học thụ động",
        ],
      },
      pro: {
        ...
        pros: [
          "Học an toàn tại nhà",
          "Hình ảnh 3D tương tác",
          "Báo cáo tiến độ chi tiết",
          "Chi phí cực tiết kiệm",
        ],
        ctaBtn: "Đăng ký học thử ngay",
      },
    },
    stats: {
      items: [
        ...
        { value: "59.000đ", label: "Chỉ Từ / Tháng" },
    ...
    loginPage: {
      ...
      teacherLogin: "Đăng nhập dành cho Giáo viên / Phụ huynh",
